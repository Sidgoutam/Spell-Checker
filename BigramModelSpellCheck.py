# -*- coding: utf-8 -*-
"""
@author: anubhav Singh cse/16149/139
""" #sidharth goutam karji cse/16032/193
...
class BigramModelSpellCheck:
	...
	def create_edited_words(self,word): #for hindi
	    CHARACTERS_TO_REPLACE=['ि','ु','े','ै','ो','ौ','़','्','ं','ँ','ी','ा','ू']
...
def main():
	...
	#bm.find_bigram_likelihood("उन्नती")
	...
	bm.find_max_edit_likelihood("ईश्वर्य राय और सलमान खान न हिदायत कार संजय भंसाली की मशहर फिल्म हम दील दे चुके सनम में साथ काम किया था",15) 
